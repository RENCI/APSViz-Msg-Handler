...
def run():
    ...
    try:
        ...
        queue_callback_inst = AsgsQueueCallback(_queue_name='asgs_props', _logger=logger)

        # start consuming the messages
        queue_callback_inst.start_consuming(queue_callback_inst.asgs_run_props_callback)
